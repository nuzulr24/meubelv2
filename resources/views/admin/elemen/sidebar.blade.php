...
<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="{{ route('list_stok') }}"><i class="fa fa-circle-o"></i> Stok</a></li>
    ...
    <li><a href="{{ route('list_pos') }}"><i class="fa fa-money"></i> <span>POS<span class="label bg-red pull-right"></span></span></a></li>
</ul>
<!-- /.sidebar-menu -->
